# P2 target trace qualification

This is the target-only acceptance contract for F-18 and F-21. Host sanitizers
...
| Wi-Fi reconnect + webhook/TLS failures | 8 h | task/handle count, HTTP create/reuse/cleanup, internal free/largest block | more than one live client, repeated worker creation, or sustained largest-block decline |
