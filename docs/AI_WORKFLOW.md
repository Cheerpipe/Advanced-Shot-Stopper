...
| Webhook or external payload | [Generic webhooks](features/webhooks.md), the [Integration API](INTEGRATION_API.md), and the native [Home Assistant integration](features/home-assistant.md). Other interfaces belong in their owning feature or architecture reference. |
