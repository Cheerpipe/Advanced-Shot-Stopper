...
#ifndef SHOT_STOPPER_DEFAULT_PADDLE_RETURN_INTERVAL_MS
#define SHOT_STOPPER_DEFAULT_PADDLE_RETURN_INTERVAL_MS 30000
#endif
#ifndef SHOT_STOPPER_DEFAULT_PADDLE_RETURN_MAX_MS
#define SHOT_STOPPER_DEFAULT_PADDLE_RETURN_MAX_MS (15UL * 60UL * 1000UL)
#endif
#ifndef SHOT_STOPPER_DEFAULT_PADDLE_RETURN_REMINDER
#define SHOT_STOPPER_DEFAULT_PADDLE_RETURN_REMINDER 1
#endif
#ifndef SHOT_STOPPER_DEFAULT_PADDLE_MODE
#define SHOT_STOPPER_DEFAULT_PADDLE_MODE 0
#endif
#ifndef SHOT_STOPPER_DEFAULT_MOMENTARY_START_ON_PRESS
#define SHOT_STOPPER_DEFAULT_MOMENTARY_START_ON_PRESS 1
#endif
#ifndef SHOT_STOPPER_DEFAULT_ASSUME_IDLE_ON_SCALE_CONNECT
#define SHOT_STOPPER_DEFAULT_ASSUME_IDLE_ON_SCALE_CONNECT 1
#endif
#ifndef SHOT_STOPPER_DEFAULT_SHOT_REACTION_TIMEOUT_S
#define SHOT_STOPPER_DEFAULT_SHOT_REACTION_TIMEOUT_S 0
#endif
#ifndef SHOT_STOPPER_DEFAULT_RINSE_ENABLED
#define SHOT_STOPPER_DEFAULT_RINSE_ENABLED 0
#endif

constexpr uint32_t DEFAULT_PADDLE_RETURN_REMINDER_INTERVAL_MS =
    SHOT_STOPPER_DEFAULT_PADDLE_RETURN_INTERVAL_MS;
constexpr uint32_t MIN_PADDLE_RETURN_REMINDER_INTERVAL_MS = 5000;
constexpr uint32_t MAX_PADDLE_RETURN_REMINDER_INTERVAL_MS = 120000;
