...
from custom_components.open_brew_by_weight.coordinator import CoordinatorData
from custom_components.open_brew_by_weight.models import DeviceSnapshot, PresetState
