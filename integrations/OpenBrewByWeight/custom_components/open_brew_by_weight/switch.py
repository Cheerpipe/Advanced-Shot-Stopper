"""Home Quick Settings switches for Open Brew by Weight."""
...
class QuickSettingSwitch(OpenBrewByWeightEntity, SwitchEntity):
    """A non-optimistic controller-owned Quick Setting."""

    entity_description: QuickSettingDescription

    def __init__(
        self, coordinator: OpenBrewByWeightCoordinator, description: QuickSettingDescription
    ) -> None:
